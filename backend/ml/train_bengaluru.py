"""
Bengaluru Model Training Script
================================
Trains Linear Regression, Random Forest, and XGBoost on Bengaluru data.
...
from preprocessing.bengaluru_prep import preprocess_bengaluru, save_encoder

DATASET_PATH = os.path.join(os.path.dirname(__file__), '../../datasets/Bengaluru_House_Data.csv')
...
def train():
    ...
    # ── Save artifacts ────────────────────────────────────────────────────
    model_path = os.path.join(MODELS_DIR, 'bengaluru_model.pkl')
    encoder_path = os.path.join(MODELS_DIR, 'bengaluru_encoder.pkl')
    metrics_path = os.path.join(MODELS_DIR, 'bengaluru_metrics.json')

    with open(model_path, 'wb') as f:
        pickle.dump(best_model, f)
    save_encoder(encoder, encoder_path)

    # Save all model metrics for the analytics dashboard
    metrics = {
